...
import { OldHeaderComponent } from '../../layout';
...
export class MidBarComponent extends OldHeaderComponent implements OnInit {
  public user = null;
  profilePic;
  showSearchBar = false;
  ...
  constructor(userService: UserService, router: Router, headerService: HeaderService, api: ApiService, cdr: ChangeDetectorRef, productService: ProductService, dialog: MatDialog, appSize: AppSizeStateService, private _router: Router) {
