...
declare var $;
@Component({
  selector: 'app-marketplace-categories-mobile',
  templateUrl: './marketplace-categories-mobile.component.html',
  styleUrls: ['./marketplace-categories-mobile.component.scss']
})
export class MarketplaceCategoriesMobileComponent extends MarketplaceCategoriesComponent implements OnInit {
  config = {
    "slidesToShow": 2,
    "slidesToScroll": 2,
    "dots": true,
